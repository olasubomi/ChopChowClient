    ...
    return (
      <div>        
        ...
        <Switch>
            ...
            />
            <Route exact path="/admin" render={(props) => ( (userToken!=="null") && (userRole==="admin"))? <AdminPanel {...props} />:(<Redirect to={{pathname:"#"}}/>)} />
            ...
            <Route exact path="/grocery" render={() => (userToken!=="null")?(<GroceryPage auth={userToken} dataTypeaheadProps={itemTypeahead} customerId={customerId}/>):(<Redirect to={{pathname:"#"}}/>)}/>
