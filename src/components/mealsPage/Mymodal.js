              ...
              <div className="row" style={{ margin: "10px" }}>
                ...
                >
                  ...
                  <div className="col-md-12 col-xs-12">
                    <h3> {value.label}</h3>
                    <div>
                      {value.readTime} mins read | {value.cookTime} mins to prepare mins to prepare
                      {/* <HeartCheckbox checked={checked} onClick={this.onClick} /> */}
                    </div>
                    <div> 
                      <button  style={{ "marginLeft": "50%",backgroundColor: "grey",color: "white"}} >
                        Compare items
                      </button>
                    </div>
                    <br />
                ...
                <div
                  className=" col-md-7 col-xs-12" style={{ paddingLeft: "25px" }}
                >
                  ...
                  <div className="row">
                    { ingredientsList &&
                      ingredientsList.map(ingredient => (
                        <div className="col-md-6" key={value.label + ingredient.product}>
