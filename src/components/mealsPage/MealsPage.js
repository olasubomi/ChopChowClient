...
class MealsPage extends Component {
  ...
  render() {
    ...
    for (const [index, value] of this.products.entries()) {
      ...
      // console.log(index);
      items.push(
        <div key={value._id} className="col-sm-12 col-md-4 col-lg-3 mealContainer">
          <div>
            <div style={containerStyle}>
              ...
              <div>
                ...
                {" "}
                <span style={{ color: "grey" }}>View Details | {value.cookTime}  mins to prepare mins to prepare</span>
                <span
                  style={{ color: "black" }}
                  onClick={() => {                    
                    this.meal_popups[index] = !this.meal_popups[index];
                ...
                <div id={value._id} style={{ display: "none" }}>
                  ...
                  <MyModal
                    value={value}
                    mealPrep={value.instructions}
                    ingredientsList={value.newer_ingredient_format }
                  />
                </div>
                <br></br>
                <br></br>
              ...
              <div id={value._id + "products"} style={{ display: "none" }}>
                {/* Meal Ingredients */}
                <br></br>
                {value.products}
                <WithScrollbar
